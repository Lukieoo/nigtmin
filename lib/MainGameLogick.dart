...
class MainLogick extends Game {
  ...
  void render(Canvas canvas) {
    if (screenSize != null) {
      ...
      if (Player2.position.dy > Enemy.componentx.y) {
  ...
  void resize(Size size) {
    ...
    enemy.add(Enemy(257, 120, "skieleton2.png"));
    //  enemy.add(Enemy(400, 160,"skieleton1.png"));
    //  enemy.add(Enemy(450, 120,"skieleton2.png"));
